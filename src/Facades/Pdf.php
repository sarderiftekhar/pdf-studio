 ...
 * @method static \PdfStudio\Laravel\Output\PdfResult reorderPages(string $pdfContent, array<int, int> $pages)
 ...
 * @method static array{valid: bool, page_count: int|null, byte_size: int} inspectPdf(string $pdfContent)
 * @method static array{valid: bool, page_count: int|null, byte_size: int} inspectPdfFile(string $path)
 * @method static array<string, string> readPdfMetadata(string $pdfContent)
 * @method static array<string, string> readPdfMetadataFile(string $path)
 ...
 * @method static array<int, \PdfStudio\Laravel\Output\PdfResult> chunkFile(string $path, int $pagesPerChunk)
 * @method static array<int, string> chunkRanges(string $pdfContent, int $pagesPerChunk)
 * @method static array<int, array{index: int, start: int, end: int, pages: int, range: string}> chunkPlan(string $pdfContent, int $pagesPerChunk)
 * @method static array<int, string> chunkRangesFile(string $path, int $pagesPerChunk)
 * @method static array<int, array{index: int, start: int, end: int, pages: int, range: string}> chunkPlanFile(string $path, int $pagesPerChunk)
 * @method static \PdfStudio\Laravel\Output\PdfResult embedFiles(string $pdfContent, array<int, array<string, mixed>> $files)
 * @method static \PdfStudio\Laravel\Output\PdfResult embedFilesIntoFile(string $path, array<int, array<string, mixed>> $files)
