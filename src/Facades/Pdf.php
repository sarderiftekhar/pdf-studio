 ...
 * @method static array{valid: bool, page_count: int|null} inspectPdf(string $pdfContent)
 * @method static array{valid: bool, page_count: int|null} inspectPdfFile(string $path)
